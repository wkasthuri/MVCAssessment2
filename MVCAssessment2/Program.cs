...
{
    var connectionString = "Server=ASUS-TUF-F15\\SQLEXPRESS;Database=CSIRO;Uid=sa;Password=jordan23;Integrated Security=True;Encrypt=False"; // configuration.GetConnectionString("DBConnection");
...
async static void DownloadData()
{
    ...
    if (response2.IsCompleted)
    {
        ...
        string connectionString = "Server=ASUS-TUF-F15\\SQLEXPRESS;Database=CSIRO;Uid=sa;Password=jordan23;Integrated Security=True;Encrypt=False";
        SqlConnection conn;
